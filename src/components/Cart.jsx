        ...
        <Layout>
            <div className="md:my-16 mx-auto md:w-7/12 bg-white shadow-lg border rounded-md p-8">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col gap-4">
                                        <div className="space-x-3">
                                            ...
                                            <del>₹{item.price}</del>
                                            <label className="text-green-400">{item.discount}% Discount</label>
                                        </div>
                                        <button className=" flex w-fit bg-rose-600 text-white px-4 py-2 rounded" onClick={()=>removeCart(item.cartId)}>
                                            <MdRemoveShoppingCart className="mr-3 ml-3 text-2xl hover:text-black"/>
                                            Remove
                                        </button>
                                    </div>
                                </div>
                ...
                <div className="flex justify-between items-center">
                    ...
                    {
                        (products.length > 0) &&
                        <button onClick={buyNow} className="bg-green-500 text-white px-10 py-3 rounded mt-4 font-semibold hover:bg-rose-600 flex">
                            <FaBagShopping className="mr-2 text-2xl mb-1 "/>
                            Buy Now
                        </button>
                    }
                </div>
